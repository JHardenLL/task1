  ...
  return (
    ...
    <div className="pinglunqv">
      <form action="">
          ...
          <p>{props.val}</p>
          <input className="button1" onClick={()=>{localStorage.removeItem(localStorage.key(props.k));
           ReactDOM.render(<App/>,document.getElementById('root')); } }type="button" value="删除"></input>
